...
import { Package, Eye, Truck, ExternalLink } from "lucide-react";
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <div className="space-y-1 text-sm">
                              <div className="flex items-center gap-2">
                                ...
                                {order.tracking.carrier_url && (
                                  <a
                                    ...
                                    className="text-[#e2603f] hover:text-[#c95a42] flex items-center text-xs cursor-pointer"
                                  >
                              ...
                              <div className="flex items-center gap-2">
                                <span className="text-gray-600">配送状況:</span>
                                <span
