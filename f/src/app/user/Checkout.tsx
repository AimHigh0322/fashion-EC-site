        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 flex items-center mt-4">
              <CreditCard className="w-6 h-6 mr-2 text-[#e2603f] cursor-pointer" />
              お支払い
            </h1>
          </div>
        </div>
              ...
              <div className="bg-white  shadow-sm p-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold text-gray-900 flex items-center">
                    <MapPin className="w-5 h-5 mr-2 text-[#e2603f] cursor-pointer" />
                    配送先
                  </h2>
                  <button
                  ...
                  >
                    <Plus className="w-4 h-4 mr-1 cursor-pointer" />
                    新しい住所を追加
                  </button>
                </div>
                ...
                {addresses.length === 0 ? (
                  <div className="text-center py-8">
                    <MapPin className="w-16 h-16 text-gray-300 mx-auto mb-4 cursor-pointer" />
                    <p className="text-gray-600 mb-4">
                      配送先が登録されていません
                    </p>
                    <button
                      onClick={() => navigate("/shipping-addresses/new")}
                      className="inline-flex items-center px-4 py-2 bg-[#e2603f] hover:bg-[#c95a42] text-white font-medium transition-colors cursor-pointer"
                    >
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          {selectedAddressId === address.id && (
                            <div className="flex-shrink-0 ml-4">
                              <div className="w-6 h-6 bg-[#e2603f] rounded-full flex items-center justify-center cursor-pointer">
              ...
              <div className="bg-white  shadow-sm p-6 sticky top-4">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                  <h3 className="text-lg font-bold text-gray-900 mb-2 flex items-center">
                    <CreditCard className="w-5 h-5 mr-2 text-[#e2603f] cursor-pointer" />
                    お支払い方法
                  </h3>
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-900 font-medium transition-colors cursor-pointer"
                >
                  戻る
                </button>
                <button
                  ...
                  disabled={processing}
                  className="flex-1 px-4 py-2 bg-[#e2603f] hover:bg-[#c95a42] disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold transition-colors flex items-center justify-center cursor-pointer"
                >
                  {processing ? (
                    <>
                      <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin mr-2"></div>
