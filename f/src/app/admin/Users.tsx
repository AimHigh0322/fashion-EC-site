              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="sticky left-0 z-10 bg-gray-50 px-2 sm:px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">
                        ユーザー
                      </th>
                      ...
                      <th className="sticky right-0 z-10 bg-gray-50 px-2 sm:px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider border-l border-gray-200">
                        操作
                      </th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-200">
                    {users.map((user) => (
                      <tr key={user.id} className="hover:bg-gray-50">
                        <td className="sticky left-0 z-10 px-2 sm:px-4 py-4 bg-white border-r border-gray-200">
                          <div className="flex items-center space-x-2 sm:space-x-3">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="text-[10px] sm:text-xs text-gray-500 truncate md:hidden">
                                {user.email}
                              </div>
                              <div className="md:hidden text-[10px] text-gray-400 mt-0.5">
                                注文: {user.orders}件
                              </div>
                              <div className="xl:hidden lg:table-cell hidden text-[10px] text-gray-400 mt-0.5">
