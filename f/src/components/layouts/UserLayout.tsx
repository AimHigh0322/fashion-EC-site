...
export const UserLayout = ({ children }: UserLayoutProps) => {
  ...
  // Clear search input when navigating away from search or on page rerender
  useEffect(() => {
  ...
  const handleSearch = (e?: React.FormEvent) => {
    ...
    if (searchTerm.trim()) {
      ...
      // Clear search when input is empty - show all products
      navigate("/");
    }
  };
          ...
          <div className="flex lg:hidden flex-col gap-2">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              {!isAuthenticated ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={logout}
                    className="p-1.5 border border-white/30 rounded transition-all duration-300 hover:opacity-90 hover:border-white/50 cursor-pointer"
                    title="ログアウト"
                  >
            ...
            <div className="w-full">
              <form onSubmit={handleSearch} className="relative w-full">
                ...
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 cursor-pointer p-1"
                >
          ...
          <div className="hidden lg:flex items-center justify-between gap-6">
            ...
            <div className="flex-1 max-w-6xl mx-8">
              <form onSubmit={handleSearch} className="relative w-full">
                ...
                <button
                  type="submit"
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 hover:scale-125 transition-all duration-300 cursor-pointer p-1 rounded hover:bg-gray-100"
                >
            ...
            <div className="flex items-center space-x-4 flex-shrink-0">
              {!isAuthenticated ? (
                ...
                <>
                  ...
                  <button
                    onClick={logout}
                    className="flex items-center space-x-2 text-sm font-medium text-white transition-all duration-300 uppercase tracking-wide cursor-pointer p-2 border border-white/30 rounded hover:scale-110 hover:opacity-90 hover:border-white/50 group"
                  >
